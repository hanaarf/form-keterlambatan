...
<head>
  ...
  <link href="css/formeditguru.css" rel="stylesheet">
</head>
...
<body id="page-top">
  <div id="wrapper">
    ...
    <div class="kanankiri">
        ...
        <p><label class="p">nama guru : <input type="text" class="input1" name="nama_guru" value="<?php echo $data['nama_guru'] ?>"  required="required"></label></p>
